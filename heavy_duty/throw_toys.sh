...
for ERA in 2016 2017 ; do
    for CHANNEL in em ; do
        for ALGO in saturated ; do
            ...
            # Throw toys
            combineTool.py -M GoodnessOfFit --algorithm $ALGO -m 125 --there -d ${PWD}/workspace.root -n ".$ALGO.toys" -t 20 -s 1220:1269:1 --verbose 0 --rMin -5 --rMax 5 --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd MINIMIZER_analytic --cminDefaultMinimizerStrategy 0 --job-mode "condor"
            cd ${CMSSW_BASE}/src/CombineHarvester/HTTSM2017
        done
    done
done
...
for ERA in 2016 2017 ; do
    ...
    combineTool.py -M GoodnessOfFit --algorithm saturated -m 125 --there -d ${PWD}/workspace.root -n ".saturated.toys" -t 20 -s 1220:1299:1 --verbose 0 --rMin -5 --rMax 5 --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd MINIMIZER_analytic --cminDefaultMinimizerStrategy 0 --job-mode "condor"
